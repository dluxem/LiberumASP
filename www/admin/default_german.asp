    ...
    <div align="center">
      <table class="Normal">
        ...
        <tr class="Body1" align="center">
          <td>
            <a href="config.asp"><%=lang(cnnDB, "Site")%>&nbsp;<%=lang(cnnDB, "Configure")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
        ...
        <tr class="Body1" align="center">
          <td>
            <a href="cfgemail.asp"><%=lang(cnnDB, "EmailMessages")%>&nbsp;<%=lang(cnnDB, "Configure")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
        ...
        <tr class="Body1" align="center">
          <td>
            <a href="viewusers.asp"><%=lang(cnnDB, "Users")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
            <a href="viewcat.asp"><%=lang(cnnDB, "Categories")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
            <a href="viewdep.asp"><%=lang(cnnDB, "Departments")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
            <a href="viewpri.asp"><%=lang(cnnDB, "Priorities")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
            <a href="viewstatus.asp"><%=lang(cnnDB, "Statuses")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
            <a href="viewlang.asp"><%=lang(cnnDB, "Languages")%>&nbsp;<%=lang(cnnDB, "Manage")%></a>
          </td>
        </tr>
        <tr class="Body1" align="center">
          <td>
